...
Scaffold buildScaffold(BuildContext context) {
  return Scaffold(
    ...
    bottomNavigationBar: BottomNavigationBarSw(),
  );
}
...
class BottomNavigationBarSw extends StatefulWidget {//重新渲染界面需要继承StatefulWidget
  @override
  State<StatefulWidget> createState() {
    return BottonNavBarState();
  }
}
int bnbcurrentIndex = 0;
class BottonNavBarState extends State {
  @override
  Widget build(BuildContext context) {
    return buildBottomNavigationBar(_onTabBottomNb);
  }
...
BottomNavigationBar buildBottomNavigationBar(void Function(int value) onTabBottomNb) {
